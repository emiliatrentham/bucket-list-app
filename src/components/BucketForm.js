      ...
      <form className="bucket-form" onSubmit={handleSubmit}>
        ...
        <div className="dropdown">
          ...
          <div className="dropdown-content">
            {/* onClick event that will set the corresponding eagerness level from the `eagernessLevel` array */}
    ...
    <div>
      ...
      <form className="bucket-form" onSubmit={handleSubmit}>
        ...
        <div className="dropdown">
          ...
          <div className="dropdown-content">
            {/* set the corresponding eagerness level from the `eagernessLevel` array */}
            <p onClick={() => setEagerness(eagernessLevel[0])}>Must do</p>
            <p onClick={() => setEagerness(eagernessLevel[1])}>Want to do</p>
            <p onClick={() => setEagerness(eagernessLevel[2])}>Take it or leave it</p>
          </div>
